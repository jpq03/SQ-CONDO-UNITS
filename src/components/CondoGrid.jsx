...
const CONDOS = [
  {
    id: 1,
    title: 'PACIFIC GRANDE // RESIDENCE 01',
    ...
    beds: 3,
    baths: 2,
    street: 'PACIFIC GRANDE RESIDENCE, TAMIYA, LAPU-LAPU CITY',
  ...
  {
    id: 2,
    title: 'ROYAL OCEANCREST // RESIDENCE 02',
    location: 'Cebu Lapu-Lapu',
    price: 8900000,
    rating: 4.92,
    reviews: 84,
    ...
    beds: 2,
    baths: 2,
    street: 'SUDTUNGGAN RD, BRGY. BASAK, LAPU-LAPU CITY, CEBU',
